  ...
  const cardData = [
    {
      ...
      Sub: "National Engineering College, Kovilpatti",
      Department: "Principal",
      Email: "principal@nec.edu.in",
      Phone: "9385976674 , 9385976684",
    },
    // {
    //   image1: Mail,
    //   image2: Call,
  ...
  return (
    ...
    overflow-hidden shadow-[0_0_10px_rgba(105,218,255,0.8),0_0_20px_rgba(240,105,255,0.8),0_0_30px_rgba(253,5,228,0.8)]"
      ...
      >
        ...
        >
          <source src={`/necconference2k26/images/NEC.mp4`} type="video/mp4" />
      ...
      <div className="content relative z-10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 mt-10 sm:mt-16 md:mt-20">
          <h1 className="coordinator text-responsive text-center" style={{ fontSize: "41px", marginTop: "80px" }} data-aos="fade-down">Conference Chairs</h1>
      ...
      <div className="map-container mt-12 text-center">
        <h1 className="location text-responsive" style={{ fontSize: "41px", marginTop: "80px" }} data-aos="fade-down">Location</h1>
        <iframe
